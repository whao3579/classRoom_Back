...
public class FaceDetectionUtils {
    ...
    public int liveDetection(File image){
        FaceEngine faceEngine = new FaceEngine("D:\\毕设\\教室管理系统\\ICRS-master\\lib\\WIN32");
        //激活引擎
        int errorCode =  faceEngine.activeOnline(SdkParameter.appId, SdkParameter.sdkKey);
