...
-- ----------------------------
INSERT INTO `department` VALUES (1, '默认权限组');
INSERT INTO `department` VALUES (2, '管理组');
INSERT INTO `department` VALUES (3, '16070942');
...
CREATE TABLE `meeting`  (
  ...
  `canceled_reason` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `student`  (
  ...
  `status` int(11) NOT NULL,
  `student_id_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1, NULL, 1, NULL, 'a3fdb038a550c69f991794e3d708d4c4', NULL, 0, 0, '113', NULL, '3ZIHQUh1Luz8XFQWdxZhfw==', b'1');
INSERT INTO `student` VALUES (8, NULL, 1, '111', 'ad5f878eaa0281f3032e69ccdb31fa0f', '11', 0, 0, '111', '111', 'QOxH3ZXMBLkQHO3Lc6p+aA==', b'1');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '35b9529f89cfb9b848060ca576237e17', '8O+vDNr2sI3N82BI31fu1A==', '管理员', '12312312312', 'evan_nightly@163.com', 1, 2, '1', '216447');
INSERT INTO `user` VALUES (2, 'test', '85087738b6c1e1d212683bfafc163853', 'JBba3j5qRykIPJQYTNNH9A==', '测试', '12312312312', '123@123.com', 1, 2, '2', '160216185');
INSERT INTO `user` VALUES (3, 'editor', '8583a2d965d6159edbf65c82d871fa3e', 'MZTe7Qwf9QgXBXrZzTIqJQ==', '编辑', NULL, NULL, 1, 2, '3', NULL);
INSERT INTO `user` VALUES (110, '160704200', 'd95e41ae64ddb80788ed39b3459d5792', 'hG81DnCiSPT52Xy99ogQzg==', '金浩', '18211111111', 'jinhao.jh@foxmail.com', 1, 1, '4', NULL);
INSERT INTO `user` VALUES (111, '1607094299', '07fe1e0b2f8f48ccd9248e2e743cf83e', 'JQLFXP3Ho9HwAomGGrq7LQ==', 'mia', '111111', 'admin@shencangblue.com', 1, 1, '5', NULL);
